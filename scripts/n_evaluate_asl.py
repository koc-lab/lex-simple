...
from mlp.BenchLS.net import FC
...
def black_box_function(bert_weight, lm_weight, cos_weight, freq_weight, len_weight):
    ...
    print("now doing: " + str(trial_count))
    ...
    tuples, scores = cross_validate_evaluator(target_path,simple_path)
    
    these_params = [bert_weight, lm_weight, cos_weight, freq_weight, len_weight]
    f1a = np.array(scores[3])
    f1 = np.mean(f1a)
...
if __name__ == '__main__':
        ...
        target_path = r"./test_raw.txt"
        simple_path = r"./test_uslt_19.txt"
